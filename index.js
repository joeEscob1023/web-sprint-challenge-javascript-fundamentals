...
/*
nested function can access the internal function because they're both placed inside of myFunction. They're in the same scope.
*/
...
function lowerCaseNames(/*Your Code Here*/) {
  ...
  zooAnimals.map(function (animal) {
    lowerCaseName.push(`${animal.animal_name.toLowerCase()}`);
  });
...
function USApop(/*Your Code Here*/) {
  const populationArr = zooAnimals.reduce(function (acc, item) {
...
// I wasn't really sure how I was supposed to use the consumeCB with the add, multiply and greeting function. Especially when the result was correct for consume()
//The results came back correct in the console below, but if is allowed since its after the test, can you show me how this was supposed to be used?
...
class CubeMaker extends CuboidMaker {
  ...
  surfaceCube() {
    return 6 * this.surfaceArea * this.surfaceArea;
  }
}
